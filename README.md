...
### Что потребуется
- **Unity**  
  Рекомендуется использовать версию, указанную в `ProjectSettings/ProjectVersion.txt`.
- **Git**
...
- **Кривилев Алексей** — тимлид
- **Тюльпин Эдуард** — программист
- **Шарычев Иван** — программист
- **Скобкарева Софья** — дизайнер

### Контакты
- **Кривилев Алексей** — `@Kam3nshchik`, `alexei.krivilev@gmail.com`

> При необходимости сюда можно добавить ссылки на GitHub, Telegram, LinkedIn, Behance и другие профили участников.
...
> Сюда можно дополнительно вставить диаграмму архитектуры из презентации или Figma.
...
### Скриншоты
Сюда можно позже добавить реальные скриншоты из игры.

```md
### Главный экран
![Главный экран](./docs/screens/main-screen.png)

### Экран практики
![Экран практики](./docs/screens/practice-screen.png)

### Экран результата
![Экран результата](./docs/screens/result-screen.png)
```
...
Проект находится в стадии **игрового прототипа**, созданного в рамках хакатона. На текущем этапе реализованы основная механика, визуальное обучение и обратная связь; часть систем пока находится на уровне проектирования и будет развиваться в следующих итерациях.
